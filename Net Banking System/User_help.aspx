<%@ Page Title="" Language="C#" MasterPageFile="~/User_Master.master" AutoEventWireup="true" CodeFile="User_help.aspx.cs" Inherits="User_help" %>
    ...
    <main>
        <section id="faq">
            ...
            <ul>
                ...
                <li>How do I transfer funds?</li>
                <li>How do I pay bills?</li>
                </ul>
        </section>
