<%@ Page Title="" Language="C#" MasterPageFile="~/Main_Master.master" AutoEventWireup="true" CodeFile="Registraction.aspx.cs" Inherits="Registraction" %>
...
<div class="div1">
        ...
        <asp:TextBox ID="TextBox4" runat="server" CssClass="txt2" 
            style="margin-left:40px" TextMode="Date"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox14" runat="server" CssClass="txt2" 
            style="margin-left:20px"  placeholder="Re-Enter Password" TextMode="Password"></asp:TextBox>
        ...
        <center><asp:Label ID="Label17" runat="server" Text="Balance in Account" CssClass="label1"></asp:Label><asp:TextBox ID="TextBox17" runat="server" CssClass="txt1" value="0" ReadOnly="true"></asp:TextBox>
        </center>
            <center>
